        ...
        <div className="navbar flex justify-between p-[20px] bg-[purple] w-[100%]">
            ...
            <nav className="elements hidden lg:block">
                ...
                <ul className="flex gap-[30px] text-white items-center">
                    ...
                    <li className="transform hover:scale-110 border-b-[white] hover:border-b-[2px] transition-all duration-200"><NavLink to="/DocumentStorage" className={({ isActive }) => `hover:cursor-pointer ${isActive ? "text-blue-400 font-bold" : "text-white"}`}>My Documents</NavLink></li>
